...
import { addExpense, getExpenses, updateExpense, deleteExpense, searchExpenseByCategory, insightsDetails,   } from "../controller/expenseController.js";
import { verifyToken } from "../middleware/authMiddleware.js";

const expenseRouter = express.Router();

expenseRouter.post("/addExpense", verifyToken, addExpense);
expenseRouter.get("/getExpenses", verifyToken, getExpenses);
